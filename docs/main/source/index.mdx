---
title: Powerful JSON forms for React.js using formik
description: formik-formly is a React.js libary which has components to help to help customize and render JavaScript/JSON configured forms.
pageTitle: Formik Formly Documentation
subTitle: An open source JSON forms library for browsers using React.js and Formik library
---

formik-formly is a React.js libary which has components to help to help customize and render JavaScript/JSON configured forms.
